...
TEST(AASLib, aal0801)
{
   // When libAAS is opened via OSServiceModuleOpen(), the value queried
   // by the standard entry point command C matches the value created by
   // the configure.ac macro M, where {C, M} are {AAL_SVC_CMD_VER_STR, AAS_VERSION},
   // {AAL_SVC_CMD_VER_CURRENT, AAS_VERSION_CURRENT},
   // {AAL_SVC_CMD_VER_REVISION, AAS_VERSION_REVISION},
   // {AAL_SVC_CMD_VER_AGE, AAS_VERSION_AGE}.
