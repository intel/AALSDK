...
vcs -nc -V +vcs+lic+wait -full64 -debug_all -Mupdate -lca -l vcs_elab.log +vhdllib+work -Mlib=work  -override_timescale=1ns/1ns -o work/ase_simv work/ase_libs.so cci_emulator -lrt -lpthread -lstdc++ -simprofile 
SIMULATOR=VCS
CC=gcc
echo "############################################################"
echo "#                                                          #"
